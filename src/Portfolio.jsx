...
const Portfolio = () => {
    ...
    const handleHeroClick = () => {
        setEasterEggCount(prev => {
            ...
            if (newCount === 7) {
                // Surprise animation after 7 clicks
                document.querySelector('.hero-title').classList.add('party-mode');
                setTimeout(() => {
                    document.querySelector('.hero-title').classList.remove('party-mode');
                }, 3000);
                return 0;
            }
            return newCount;
    ...
    const BackToTopButton = () => {
        ...
        return (
            <a href="#hero" className="back-to-top-cloud" aria-label="Back to top">
    ...
    return (
        <div className={`portfolio ${isLoaded ? 'loaded' : ''}`}>
            ...
            <ProjectSection scrapiPreview={scrapiPreview}   />
